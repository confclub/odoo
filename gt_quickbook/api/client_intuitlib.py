...
from odoo.addons.gt_quickbook.api.utils import (
    get_discovery_doc,
    generate_token,
    scopes_to_string,
    get_auth_header,
...
class AuthClient(requests.Session):
    ...
    def __init__(self, client_id, client_secret, redirect_uri, environment, state_token=None, access_token=None, refresh_token=None, id_token=None, realm_id=None):
        # print "inittttttttttttttttttttttttt222222222222222222"
    ...
    def get_authorization_url(self, scopes, state_token=None):
        # print "get_authorization_urlllllllllllllllllllllll",scopes
    ...
    def get_bearer_token(self, auth_code, realm_id=None):
        # print "get_bearer_tokennnnnnnnnnnnnnnnnnnn", auth_code
        ...
        # print "Headerrrrrrrrrrrrrrrrrrr",headers
        ...
        # print "BODYYYYYYYYYYYYYYYYYY",body
