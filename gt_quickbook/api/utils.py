...
from odoo.addons.gt_quickbook.api.exceptions_intuitlib import AuthClientError
# from intuitlib.exceptions import AuthClientError

from odoo.addons.gt_quickbook.api.config import DISCOVERY_URL, ACCEPT_HEADER
