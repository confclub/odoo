...
class ContractProduct(models.Model):
    ...
    product_pack_id = fields.Many2one('product.product')
    ...
    num_daily_packs = fields.Integer(
        help='how many daily packs of this product are in the order (their deliveries are combined for efficiency)')
